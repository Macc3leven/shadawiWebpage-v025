import {assetApiUrl, specimenObject} from './utils/exampleSpecimen.js';
...
function handleInput(value) {
    ...
    if (value.length < 1) searchInput.style.backgroundImage = `url(../images/searchIcon.png)`;
...
const specimenData = [
    {
        ...
        sid: 101,
        class: "UNDEAD",
        img: "./images/domig.png",
    },
    {
        name: "#102 MIGHTY BIRD",
        sid: 102,
        class: "DIVINE",
        img: "./images/mightybird.png",
    },
    {
        name: "#103 CLOUD OGRE",
        sid: 103,
        class: "GAS",
        img: "./images/cloudogre.png",
    },
    {
        name: "#104 SEAPUNK",
        sid: 104,
        class: "GAS",
        img: "./images/seapunk.png",
    }
];
...
function createSpecimenCard(indx = 0) {
    ...
    newCard.style.backgroundImage = `url(${content.img})`; // Ensure background image is set with url()
    ...
    console.log(content.class, "class", content)
...
function createSpecimenModal(specimenObject) {
    ...
    const {sid, name, image, description} = specimenObject;
    ...
    specimenObject.attributes.forEach(attr => {
    ...
    specimenObject.stats.forEach(stat => {
        let p = document.createElement('p');
        p.className = 'stat_item';
